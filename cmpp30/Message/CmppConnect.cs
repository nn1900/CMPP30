...
namespace Reefoo.CMPP30.Message
{
  ...
  internal struct CmppConnect : ICmppMessage
  {
    ...
    /// </remarks>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 6)] public string SourceAddress;
    ...
    /// </summary>
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] AuthenticatorSource;
