...
namespace Reefoo.CMPP30.Message
{
  ...
  internal struct CmppSubmit : ICmppMessage
  {
    ...
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 10)] public string ServiceId;
    ...
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string FeeTerminalId;
    ...
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 6)] public string MsgSrc;

    /// <summary>
    /// 资费类别（01：对“计费用户号码”免费；02：对“计费用户号码”按条计信息费；03：对“计费用户号码”按包月收取信息费）。
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 2)] public string FeeType;

    /// <summary>
    /// 资费代码（以分为单位）。
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 6)] public string FeeCode;

    /// <summary>
    /// 存活有效期，格式遵循SMPP3.3协议。
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 17)] public string ValidTime;

    /// <summary>
    /// 定时发送时间，格式遵循SMPP3.3协议。
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 17)] public string AtTime;

    /// <summary>
    /// 源号码（SP的服务代码或前缀为服务代码的长号码, 网关将该号码完整的填到SMPP协议Submit_SM消息相应的source_addr字段，该号码最终在用户手机上显示为短消息的主叫号码）。
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 21)] public string SrcId;
    ...
    /// </summary>
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 20)] public string LinkId;
